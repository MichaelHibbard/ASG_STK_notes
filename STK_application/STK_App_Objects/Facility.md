...
For selected ground sites, it will include azimuth/elevations masks. These masks define the elevation angle of a satellite required to view the ground site in the azimuth direction. Please refer to the section on [Azimuth-Elevation Masks](AzEl_masks.md) for more information.
